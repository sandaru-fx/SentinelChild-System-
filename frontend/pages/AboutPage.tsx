...
export default function AboutPage() {
  ...
  return (
    <div className="space-y-24 pb-32 animate-fade-in">
      <section className="pt-24 pb-20 px-4 bg-gradient-to-b from-blue-50 to-white text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="inline-flex items-center gap-2 bg-blue-600/10 text-blue-700 px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border border-blue-200/50">
             <i className="fas fa-bullseye"></i> Our Mission
          </div>
          <h1 className="text-5xl md:text-7xl font-black text-slate-900 tracking-tighter leading-tight">Mission: Zero Tolerance</h1>
      ...
      <section className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        <div className="space-y-12 text-left">
          <div className="space-y-4">
             <h2 className="text-3xl font-black text-slate-900 tracking-tight">The Forensic Lifecycle</h2>
             <p className="text-slate-500 font-medium">How we turn anonymous data into actionable legal protection.</p>
          </div>
          <div className="space-y-8">
            {[
              ...
              <div key={i} className="flex gap-8 group cursor-default p-8 bg-white rounded-[2.5rem] border-2 border-slate-50 hover:border-indigo-600 hover:ring-4 hover:ring-indigo-600/20 hover:ring-offset-4 hover:-translate-y-2 transition-all duration-500">
                <span className="text-5xl font-black text-blue-100 italic group-hover:text-indigo-600 transition-colors duration-500 shrink-0">{item.step}</span>
                <div className="space-y-1 pt-1">
                  <h4 className="text-lg font-black text-slate-900 group-hover:text-indigo-600 transition-colors">{item.title}</h4>
      ...
      <section className="max-w-7xl mx-auto px-4 text-center">
         <h2 className="text-xs font-black text-slate-400 uppercase tracking-[0.3em] mb-12">Institutional Collaborators</h2>
         <div className="grid grid-cols-2 md:grid-cols-4 gap-12 opacity-40 grayscale hover:grayscale-0 transition-all duration-700">
            <div className="flex items-center justify-center font-black text-2xl tracking-tighter text-slate-900">GOV.LK</div>
            <div className="flex items-center justify-center font-black text-2xl tracking-tighter text-slate-900">POLICE BUREAU</div>
            <div className="flex items-center justify-center font-black text-2xl tracking-tighter text-slate-900">UNICEF</div>
            <div className="flex items-center justify-center font-black text-2xl tracking-tighter text-slate-900">NGOCouncil</div>
         </div>
      </section>
    </div>
  );
